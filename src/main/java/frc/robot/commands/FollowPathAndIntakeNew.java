...
public class FollowPathAndIntakeNew extends ParallelDeadlineGroup {
  /** Creates a new FollowPathAndIntakeNew. */
  public FollowPathAndIntakeNew(Trajectory trajectory, DriveTrain driveTrain, Intake intake, BallRun ballRun) {
    ...
    super(new InstantCommand(ramseteCommand));
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new RunIntake(intake, ballRun),
      new InstantCommand(() -> driveTrain.resetOdemetry(trajectory.getInitialPose()))
    );
  }
}
